...
const qsc_encoding_t Kyber512_encoding = {
    .algorithm_name = QSC_ALGORITHM_KEM_KYBER_512_R3_NAME,
...
const qsc_encoding_t Kyber768_encoding = {
    .algorithm_name = QSC_ALGORITHM_KEM_KYBER_768_R3_NAME,
...
const qsc_encoding_t Kyber1024_encoding = {
    .algorithm_name = QSC_ALGORITHM_KEM_KYBER_1024_R3_NAME,
